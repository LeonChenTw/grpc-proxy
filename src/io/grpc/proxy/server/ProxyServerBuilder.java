...
public class ProxyServerBuilder {
	...
	public static class Builder {
		...
		public Builder addService(Object service) {
            ...
            List<Class> effectiveClassAnnotations =
                            ReflectionHelper.getEffectiveClassAnnotations(service.getClass(), GrpcService.class);
			if( effectiveClassAnnotations.size() != 1 ) {
                String msg = effectiveClassAnnotations.isEmpty()
                                ? "No Interfaces implementing GrpcService annotation"
